...
1.  **Direct Inquiry**: Any message from a person that requires a unique, contextual response. This includes:
    - Questions, replies, business proposals, and casual conversation
    - Text messages or phone call transcriptions forwarded via services like Google Voice
    - Any email containing phone numbers in the FROM field (e.g., from phone number@txt.voice.google.com)
    - SMS/text notifications that contain actual message content from a person
...
3.  **Advertisement**: Automated marketing emails, newsletters, promotions, social media notifications (like from Reddit), or spam that do not contain actual person-to-person communication. These do not require a personal reply.

**Important Rules:**
- If an email is FROM a phone number (contains digits in the sender), it's a Direct Inquiry
- If an email contains "New text message from" or similar phone/SMS indicators, it's a Direct Inquiry
- Google Voice notifications containing actual message content are Direct Inquiries
...
-   **Text:** "New text message from (786) 886-9169: Good when coming. Yes. The Company ask me what type of cargo"
    **Classification:** Direct Inquiry
-   **Text:** "From: 17868869169@txt.voice.google.com - I mean, what goods will I be transporting?"
    **Classification:** Direct Inquiry
...
app.get('/api/thread/summary/:assistantId/:threadId', isVerified, async (req, res) => {
    ...
    try {
        ...
        // --- ADDED FOR DEBUGGING ---
        console.log('--- Thread Summary Request ---');
